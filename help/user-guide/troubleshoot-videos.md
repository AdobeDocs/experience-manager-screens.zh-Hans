...
### 检查视频组件{#checking-profile-with-a-video-component}的用户档案

如果视频组件配置不正确，请检查页面设计中的列表。

1. 导航到您的渠道并选择&#x200B;**Design**&#x200B;模式。
...
使用&#x200B;**Web播放器** `http://localhost:4502/content/mobileapps/cq-screens-player/firmware.html/content/screens/we-retail/locations/demo/flagship/single/device0`验证在浏览器（Chrome和Safari）中的播放。 Chrome用于Android设备，而Safari是OSX和iOS浏览器。
