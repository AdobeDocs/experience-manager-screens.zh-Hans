...
1. 单击渠道。 例如， **`We.Retail In Store`** > **渠道** > **空闲通道**.
...
1. 单击要在其中添加组件的渠道。 例如， **`We.Retail In Store`** > **渠道** > **空闲通道**.

1. 单击 **编辑** 从操作栏中。
1. 单击 **设计** 模式。
1. 单击右侧的整个设计编辑器，然后单击设置符号，以便您可以打开 **Parsys设计** 对话框。
1. 您可以单击要导入到AEM Screens项目的组件。 以下示例显示了 **Livefyre** AEM Screens项目的组件。
