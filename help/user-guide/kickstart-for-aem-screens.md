...
1. 输入标题为 **DemoScreens**，然后单击 **保存**.
   ...
   >[!NOTE]
   >创建项目后，将返回到AEM Screens项目主页。 您现在可以单击项目。 在项目中，有五个标题为 **应用程序**， **渠道**， **设备**， **位置**、和 **时间表**.
...
1. 创建项目后，单击 **DemoScreens** 项目，然后单击 **渠道** 文件夹，如下图所示。 单击 **+创建** 从操作栏中。
...
1. 导航至 **演示项目** 您已创建，然后单击 **TestChannel** 从 **渠道** 文件夹。
...
1. 如果 **注册码** 两台计算机上相同，请单击 **验证** 在AEM中。
...
1. 单击显示的路径 **DemoScreens** > **位置** > **TestLocation** > **LobbyDisplay** 并单击 **分配**.
...
1. 单击 **完成** 以完成注册流程。 您现在可以从显示仪表板查看已注册的设备。
