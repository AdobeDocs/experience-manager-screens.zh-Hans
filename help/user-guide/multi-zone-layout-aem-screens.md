...
***多区域布局*** 允许您创建多个区域内容并使用可在单个屏幕中组合的各种资产，如视频、图像和文本。 您可以纳入图像、视频和文本，使它们能够混合在一起，创建直观的数字体验。
...
在创建渠道时，您可以使用不同的模板以在渠道中创建区域。 您可以添加单个图像、视频或嵌入式渠道，以便按顺序显示多个资产。
...
1. **将渠道分配给显示**
   ...
   1. 将三个渠道分配给 **大厅** ”时，您应该能够从“显示”功能板中查看分配的渠道。
      ...
      >[!IMPORTANT]
      >
      > 分配主渠道后(在本例中， **多区**)，必须分配其他两个嵌入渠道 **区域1** 和 **区域2** 也显示相同的内容。
...
1. **注册设备**
   ...
   1. 如果标题与设备令牌匹配，请选择设备并单击 **注册设备** 从操作栏中。
