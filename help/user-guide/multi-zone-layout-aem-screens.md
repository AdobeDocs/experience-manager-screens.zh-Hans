...
1. 导航到 **渠道** 文件夹并单击 **创建** 从操作栏中。

1. 单击 **1x2分屏渠道** 从 **创建** 向导。
...
1. **创建渠道文件夹**
   ...
   1. 导航到 **区域** > **多区** > **渠道** 并单击 **创建** 从操作栏中。
   1. 单击 **渠道文件夹** 从 **创建** 向导并单击 **下一个**.
...
1. **将两个以上的渠道添加到渠道文件夹**
   ...
   1. 导航到 **区域** > **渠道** > **嵌入式渠道** 并单击 **创建** 从操作栏中。
   1. 单击 **序列渠道** 从 **创建** 创建标题为 **`Zone1`**.
   1. 单击 **`Zone1`** 并单击 **编辑** 从操作栏中。
   1. 将一些图像拖放到此渠道中。
...
1. **将嵌入式序列（组件）添加到主通道(MultiZone)**
   ...
   1. 单击渠道路径作为 **区域** > **渠道** > **嵌入式渠道** > **`Zone1`**，如下图所示。
...
1. **创建位置**
   ...
   1. 导航到 **区域** > **位置** 文件夹。
   1. 单击 **位置** 文件夹并单击 **创建** 从操作栏中。
   1. 单击 **位置** 从 **创建** 向导并单击 **下一个**.
   1. 输入 **标题** 作为 **圣何塞** 并单击 **创建**.

1. **创建显示**

   1. 导航到 **区域** > **位置** 文件夹。
   1. 单击 **圣何塞** 位置并单击 **创建** 从操作栏中。
   1. 单击 **显示** 从 **创建** 向导并单击 **下一个**.
...
1. **注册设备**
   ...
   1. 单击 **设备注册** 并从列表中单击挂起设备。

      >[!NOTE]
      > 设备的标题必须与设备令牌匹配(**令牌** 字段)，显示在 **设备注册** 选项卡。

   1. 如果标题与设备令牌匹配，请单击设备，然后单击 **注册设备** 从操作栏中。
   1. 如果注册代码与Screens播放器中的代码匹配 **设备注册** 选项卡，单击 **验证** 从操作栏中。
      ![图像](/help/user-guide/assets/multi-zone/multizone-img6.png)
   1. 输入 **标题** 作为 **`Chrome-Device1`** 并单击 **注册**.
   1. 单击 **分配显示区** 并单击设备配置的路径。

   >[!NOTE]
   >如果您尝试在Screens播放器中查看内容，请确保单击 **更新离线内容** 从渠道功能板中，找到分配给显示的每个渠道。
