...
***多区域*** 布局允许您创建多个区域内容并使用可以组合到单个屏幕中的各种资源，如视频、图像和文本。您可以拖入图像、视频和文本，使其融为一体，创造直观的数字体验。
...
在创建渠道时，您可以使用不同的模板在渠道中创建区域。 您可以添加单个图像、视频或嵌入式渠道，以便在序列中显示多个资产。
...
1. 单击&#x200B;**下一步**&#x200B;并输入&#x200B;**title**&#x200B;作为&#x200B;**MultiZone**。

1. 单击&#x200B;**创建**&#x200B;以完成渠道创建。

### 在一个或多个区域中使用单个资产{#using-single-assets-in-one-or-more-zones}

您可以在所有单独区域中使用单个资产，如图像或视频。 请按照以下步骤实施：
...
1. **创建渠道文件夹**
   ...
   1. 从&#x200B;**创建**&#x200B;向导中选择&#x200B;**渠道文件夹**，然后单击&#x200B;**下一步**。
   1. 输入&#x200B;**EmbeddedChannels**&#x200B;的标题，然后单击&#x200B;**创建**。
...
1. **将另外两个渠道添加到渠道文件夹**
   ...
   1. 将很少的图像拖放到此渠道。
   1. 同样，在&#x200B;**EmbeddedChannels**&#x200B;文件夹中创建另一个标题为&#x200B;**Zone2**&#x200B;的序列渠道。
   1. 将视频拖放到此渠道。
...
1. **将嵌入式序列（组件）添加到主渠道(MultiZone)**
   ...
   1. 在其中一个区域中选择嵌入式序列。
   1. 单击编辑器中某个嵌入式序列的&#x200B;**配置**（扳手）图标。
   1. 将渠道路径选为&#x200B;**Zones** —> **渠道** —> **EmbeddedChannels** —> **Zone1**，如下图所示。
...
您必须创建一个位置和显示屏来视图Screens播放器中的内容。 请按照以下步骤创建位置和显示屏。

1. **创建位置**

   1. 导航到&#x200B;**Zones** —> **Locations**&#x200B;文件夹。
   1. 选择&#x200B;**位置**&#x200B;文件夹，然后单击操作栏中的&#x200B;**创建**。
   1. 从&#x200B;**创建**&#x200B;向导中选择&#x200B;**位置**，然后单击&#x200B;**下一步**。
   1. 在&#x200B;**Title**&#x200B;中输入&#x200B;**SanJose**，然后单击&#x200B;**创建**。
...
1. **创建显示屏**
   ...
   1. 将&#x200B;**标题**&#x200B;输入为&#x200B;**休息室**，然后单击&#x200B;**创建**。

### 将渠道分配给显示{#channel-channel}

您必须将渠道分配给显示屏以视图内容。 请按照以下步骤将渠道分配给显示屏。

1. **将渠道分配给显示屏**

   1. 导航到&#x200B;**Zones** —> **位置** —> **SanJose**—> **Lobby**。
   1. 选择&#x200B;**休息室**&#x200B;显示屏，然后单击操作栏中的&#x200B;**分配渠道**。
   1. 在&#x200B;**渠道路径**&#x200B;中输入&#x200B;**MultiZone**&#x200B;渠道的路径。
   1. 将&#x200B;**支持的事件**&#x200B;设置为&#x200B;**初始负载**、**空闲屏幕**&#x200B;和&#x200B;**计时器**。
   1. 单击&#x200B;**保存**。

      ![图像](/help/user-guide/assets/multi-zone/multizone-img9.png)
   1. 同样，您也必须将另外两个嵌入渠道（**Zone1**&#x200B;和&#x200B;**Zone2**）分配给此显示屏。
   1. 将所有三个渠道分配给&#x200B;**Lobby**&#x200B;显示屏后，您应能够从显示仪表板视图分配的渠道。
      ...
      >[!IMPORTANT]
      >
      > 一旦将主渠道（在本例中为&#x200B;**MultiZone**）分配给显示屏，则必须将另外两个嵌入式渠道&#x200B;**Zone1**&#x200B;和&#x200B;**Zone2**&#x200B;也分配给同一显示屏。
...
1. **注册设备**
   ...
   1. 单击&#x200B;**设备注册**&#x200B;并从列表中选择挂起的设备。

      >[!NOTE]
      > 设备的标题必须与&#x200B;**设备注册**&#x200B;选项卡中显示的设备令牌（**令牌**&#x200B;字段）匹配。
   1. 如果标题与设备令牌匹配，则选择设备，然后单击操作栏中的&#x200B;**注册设备**。
   1. 如果注册代码与Screens播放器&#x200B;**设备注册**&#x200B;选项卡中的代码匹配，请单击操作栏中的&#x200B;**验证**。
      ![图像](/help/user-guide/assets/multi-zone/multizone-img6.png)
   1. 将&#x200B;**Title**&#x200B;输入为&#x200B;**Chrome-Device1**&#x200B;并单击&#x200B;**注册**。
   1. 选择&#x200B;**指定显示**&#x200B;并选择设备配置的路径。

   >[!NOTE]
   >如果您尝试视图Screens播放器中的内容，请确保为分配给显示屏的每个渠道单击渠道仪表板中的&#x200B;**更新脱机内容**。

### 查看结果{#viewing-the-result}

使用上述步骤实施多区域布局后，将显示以下输出。

选中Screens播放器以视图显示两个不同区域中内容的输出。 左侧和右侧区域（两者都使用嵌入式序列作为组件）。
