...
>
>***“动态嵌*** 入序列”允许您显示特定于位置的内容，而“ ***嵌*** 入序列”仅显示内容的一般幻灯片。此外，在设置动态嵌入式序列时，您需要使用渠道角色和名称配置渠道。 有关实际实施，请参阅以下步骤。
>
>要了解有关实现嵌入式序列的更多信息，请参阅AEM Screens中的[嵌入式序列](embedded-sequences.md)。
...
1. **在每个位置文件夹下创建两个位置和一个渠道。**
   ...
   1. 导航到&#x200B;**Demo** —> **位置** —> **区域A**。
   1. 选择&#x200B;**区域A**&#x200B;并单击操作栏中的&#x200B;**+创建**。
   1. 从向导中选择&#x200B;**位置**，将&#x200B;**标题**&#x200B;作为&#x200B;**商店1**。 同样，从标题为&#x200B;**Store 2**&#x200B;的向导中创建另一个位置，其中&#x200B;**Title**&#x200B;为&#x200B;**Store 2**。 在创建&#x200B;**存储1**&#x200B;和&#x200B;**存储2**&#x200B;时，可将&#x200B;**名称**&#x200B;字段留空。
   1. 重复步骤(b)，现在从向导中选择&#x200B;**序列渠道**。 在&#x200B;**标题**&#x200B;中输入&#x200B;**区域A**&#x200B;和&#x200B;**名称**&#x200B;作为此渠道的&#x200B;**区域**。
...
1. **在每个位置下创建显示和渠道。**
   ...
   1. 重复步骤(b)，此时从向导中选择&#x200B;**序列渠道**。 将&#x200B;**Title**&#x200B;输入为&#x200B;**Store1渠道**，将&#x200B;**Name**&#x200B;输入为&#x200B;**store**。

   >[!CAUTION]
   >
   >创建序列渠道时，渠道的&#x200B;**Title**&#x200B;可以作为您的要求，但所有本地渠道中的&#x200B;**Name**应相同。
   >在本例中，**区域A**&#x200B;和&#x200B;**区域B**&#x200B;下的渠道与&#x200B;**区域**&#x200B;和&#x200B;**存储1**、**存储2&lt;a11下的渠道共享相同的**&#x200B;名称&#x200B;**/>、**&#x200B;商店3 **和**&#x200B;商店4 **与**&#x200B;商店&#x200B;**共享相同的**&#x200B;名称&#x200B;**。**
...
* **地区 — 作者**:由对区域和区域B具有读取、写入和编辑 **权** 限 **的用户组成**。
...
1. **创建用户并将用户添加到用户组**
   ...
   1. 导航到&#x200B;**Adobe Experience Manager**。
   1. 单击&#x200B;**工具** —> **安全** —> **用户**。
   1. 单击&#x200B;**创建用户**，并在&#x200B;**ID**&#x200B;中输入&#x200B;**全局用户**。
   1. 输入&#x200B;**密码**&#x200B;并确认此用户的密码。
   1. 单击&#x200B;**组**&#x200B;选项卡并在&#x200B;**选择组**&#x200B;中输入组名称，例如，输入&#x200B;**全局作者**&#x200B;将&#x200B;**全局用户**&#x200B;添加到该特定组。
   1. 单击&#x200B;**保存并关闭**。
...
1. **修改每个用户组的权限**
   ...
   **对于全局作者：**
   ...
   下图显示，现在&#x200B;**全局用户**&#x200B;可访问&#x200B;**全局渠道**&#x200B;和&#x200B;**区域A**&#x200B;和&#x200B;**区域B**，所有四个存储都为&#x200B;**存储1**&#x200B;和&#x200B;**存储2**、**存储3**&#x200B;和&#x200B;**存储4**。
   ...
   **对于区域作者：**
   ...
   下图显示，现在区域用户可访问&#x200B;**区域A**&#x200B;和&#x200B;**区域B**，所有四个存储区即&#x200B;**存储区1**、**存储区2**、**存储区3**&#x200B;和&#x200B;**存储4**，但无法访问&#x200B;**Global**&#x200B;渠道。
   ...
   **对于商店 — 作者：**
   ...
   1. 导航到&#x200B;***/content/screens/demo/locations***&#x200B;并仅检查&#x200B;**读取**&#x200B;权限。
   1. 导航到&#x200B;***/content/screens/demo/渠道***&#x200B;并取消检查&#x200B;**全局**&#x200B;渠道的权限。
   1. 导览至&#x200B;***/content/screens/demo/locations/region-a***&#x200B;并仅检查&#x200B;**读取**&#x200B;权限。 同样，请仅检查&#x200B;**region-b**&#x200B;的&#x200B;**读**&#x200B;权限。
   1. 导航到&#x200B;***/content/screens/demo/locations***/***region-a /store-1***&#x200B;并检查所有权限。 同样，请检查&#x200B;**store-2、store-3、**&#x200B;和&#x200B;**store-4**&#x200B;的权限。

   请参阅下图以了解这些步骤：

   ![screen_shot_2018-09-18at12415pm](assets/screen_shot_2018-09-18at12415pm.png)

   下图显示，现在&#x200B;**Store-User**&#x200B;只能访问四个存储，即&#x200B;**Store 1**、**Store 2**、**Store 3**&#x200B;和&#x200B;**Store 4**，但无权访问&#x200B;**全局**&#x200B;或区域（**区域A**&#x200B;和&#x200B;**区域B**）渠道。
