...
1. **在每个位置文件夹下创建两个位置和一个渠道。**
   ...
   1. 单击 **位置** 从向导，使用 **标题** 作为 **商店1**. 同样，从向导创建另一个位置，标题为 **商店2** 替换为 **标题** 作为 **商店2**. 您可以离开 **名称** 创建时字段为空 **商店1** 和 **商店2**.
...
1. **将渠道分配给计划**
   ...
   1. 单击 **引用渠道** 按路径。
   1. 单击 **渠道路径** 作为 **演示** > ***渠道*** > ***全局***.
   1. 输入 **渠道角色** 作为 **全局广告区段**.
   1. 单击 **受支持的事件** 作为 **初始加载**， **空闲屏幕**、和 **用户交互**.
   1. 单击&#x200B;**保存**。
