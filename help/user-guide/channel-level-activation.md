...
1. **在位置下创建显示**
   ...
   1. 导航到 **渠道级别激活** > **位置** > **区域**.
   1. 单击 **区域** 并单击 **+创建** 从操作栏中。
   1. 单击 **显示** 并创建一个标题为 **区域显示。**
...
1. **分配要显示的渠道**
   ...
   1. **渠道分配** 对话框打开。
   1. 单击 **引用渠道** 按路径。
   1. 单击 **渠道路径** 作为 **渠道级别激活** > ***渠道*** > ***MainAdChannel***.
   1. 此 **渠道角色** 填充为 **mainadchannel**.
   1. 单击 **优先级** 作为 **1**.
   1. 单击 **受支持的事件** 作为 **初始加载** 和 **空闲屏幕**.
   1. 单击&#x200B;**保存**。
   ...
   >[!NOTE]
   >
   >您还可以通过导航到，从显示功能板分配渠道 **渠道级别激活** > **位置** > **区域** > **区域显示** 并选择 **仪表板** 从操作栏中。 单击 **+分配渠道** 从 **已分配的渠道和计划** 面板。
   ...
   1. **渠道分配** 对话框打开。
   1. 单击 **引用渠道** 按路径。
   1. 单击 **渠道路径** 作为 **渠道级别激活*** > ***渠道*** > ***targetedsingleplay***.
   1. 此 **渠道角色** 填充为 **targetedsingleplay**.
   1. 设置 **优先级** 作为 **2**.
   1. 单击 **受支持的事件** 作为 **初始加载**， **空闲屏幕**、和 **计时器**，如下图所示。
   1. 选择日期 **保持活动状态起始日期** 截至2018年11月27日晚上11点59分及下午 **保持活动状态结束日期** 截至2018年11月28日凌晨十二点零刻
   1. 单击&#x200B;**保存**。

   >[!CAUTION]
   >
   >设置优先级 **targetedsingleplay** 渠道高于 **MainAdSegment** 渠道。
...
| 1月第一日下午2点以后也是在1月第二日凌晨3点之前的1月第三天。 | 渠道中的资产在1月1日下午2点后开始播放，并在1月2日继续播放一整天，一直到1月3日凌晨3点 |
...
| **表达式** | **解释** |
|---|---|
| 之 `February,May,August,November` | 该资产将于2月、5月、8月、11月在渠道中播放 |
