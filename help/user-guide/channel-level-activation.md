...
* 创建渠道为 **MainAdChannel** 在 **渠道** 文件夹。

* 创建其他渠道为 **targetedsingleplay** 在 **渠道** 文件夹。
...
1. **分配要显示的渠道**
   ...
   >[!NOTE]
   >
   >您还可以从显示功能板分配渠道。 导航到 **渠道级别激活** > **位置** > **区域** > **区域显示**. 在操作栏上，选择 **仪表板**. 从 **已分配的渠道和计划** 面板，单击 **+分配渠道**.

   同样，分配渠道 **targetedsingleplay** 用于显示**：

   1. 导航到 **渠道级别激活** > **位置** > **区域** > **区域显示** 并单击 **分配渠道** 从操作栏中。
   1. 在 **渠道分配** 对话框中，单击 **引用渠道** 按路径。
   1. 单击 **渠道路径**，然后单击 **渠道级别激活** > ***渠道*** > ***targetedsingleplay***.
   1. 此 **渠道角色** 填充为 **targetedsingleplay**.
   1. 设置 **优先级** 到 **2**.
   1. 单击 **受支持的事件**，并设置 **初始加载**， **空闲屏幕**、和 **计时器**，如下图所示。
   1. 在 **保持活动状态起始日期**，设置于2018年11月27日晚上11点59分并位于 **保持活动状态结束日期**，设置为2018年11月28日半夜12:05
   1. 单击&#x200B;**保存**。
...
假设您只想在星期五下午1:00到晚上10:00显示某个渠道的内容。 您可以使用 **激活** 选项卡，为资源设置所需的重复间隔。
