...
必须安装最低版本的AEM 6.5功能包8才能使AMS连接器正常工作。 请参阅 [可用性](https://experienceleague.adobe.com/docs/experience-manager-screens/user-guide/release-notes/release-notes-fp-202105.html?lang=en#availability) 以获取功能包的最低版本。