...
>**重要隐私信息**
>
>使用语音识别功能时，请遵循您所在地区的所有适用法律和道德准则（包括但不限于向最终用户显示播放器正在使用语音识别）。 Adobe Inc不接收、存储或处理任何语音相关信息。 AEM Screens播放器使用内置于浏览引擎中的标准Web语音API。 在后台，此API会向Google的服务器发送语音波形，以便从语音转换为文本，播放器会根据配置的关键字匹配此文本。
>
...
内容作者可以将显示配置为启用语音。 此功能的目的是允许客户利用语音作为与其显示器交互的方法。 一些类似用例包括在商店中寻找产品推荐、在用餐者和餐厅订购菜品。 此功能增加了用户的可访问性，并可以极大地增强客户体验。
...
要在AEM Screens项目中实现语音识别，您必须为显示启用语音识别，并将每个渠道与唯一标签关联以触发渠道过渡。

下节介绍如何在AEM Screens项目中启用和使用语音识别功能。

## 在全屏或分屏渠道开关{#sequence-channel}中查看内容

在使用语音识别功能之前，请确保您有一个项目和一个渠道，其中包含为您的项目设置的内容。
...
1. 导航到每个渠道并添加内容。 例如，导航到&#x200B;**VoiceDemo** —> **渠道** —> **主**&#x200B;并选择渠道。 单击操作栏中的&#x200B;**编辑**&#x200B;以打开编辑器并根据需要添加内容（图像/视频）。 同样，向&#x200B;**ColdDrinks**&#x200B;和&#x200B;**HotDrinks**&#x200B;渠道添加内容。
   ...
   **热饮**:
   ...
   如果您已将“分屏”渠道添加到项目，请导航到&#x200B;**SplitScreen**&#x200B;并拖放两个嵌入式序列，并添加到&#x200B;**ColdDrinks**&#x200B;和&#x200B;**热饮**渠道的路径，如下图所示。
   ![图像](assets/voice-recognition/vr-emb-6.png)


### 设置渠道{#setting-tags}的标记

在向渠道添加内容后，您需要导航到每个渠道并添加相应的标记，以触发语音识别。
...
1. 导航到&#x200B;**Basics**&#x200B;选项卡，从&#x200B;**Tags**&#x200B;字段中选择已存在的标签，或创建新标签。
...
1. 同样，将标题为&#x200B;**hot**&#x200B;的标签添加到&#x200B;**HotDrinks**&#x200B;渠道。

1. 如果您使用的是“拆分屏幕”渠道，请将标签（**hot**&#x200B;和&#x200B;**cold**）添加到&#x200B;**SplitScreen**&#x200B;渠道属性中，如下图所示。
...
### 将渠道分配到显示屏并启用语音识别{#channel-assignment}
...
1. 将渠道&#x200B;**Main**、**ColdDrinks**&#x200B;和&#x200B;**HotDrinks**&#x200B;分配给您的&#x200B;**LobbyDisplay**。 此外，如果您正在使用项目的&#x200B;**SplitScreen**&#x200B;渠道，请确保也将此分配给显示屏。

   >[!NOTE]
   >如果已创建拆分屏幕渠道，请将&#x200B;**SplitScreen**&#x200B;渠道分配给您的显示屏。
...
1. 为显示屏分配渠道后，请导航到&#x200B;**LobbyDisplay**&#x200B;并选择显示屏。 从操作栏中选择&#x200B;**属性**。

1. 导航到&#x200B;**Display**&#x200B;选项卡，并在&#x200B;**Content**&#x200B;下启用&#x200B;**Voice enabled**&#x200B;选项。
...
### 在Chrome Player中查看内容{#viewing-content}

完成上述步骤后，您可以注册您的镶边设备以视图输出。
...
**Main**&#x200B;渠道正在播放其内容，但是当您使用关键字&#x200B;**hot**（如&#x200B;*）的词时，我想要热饮*,渠道开始播放&#x200B;**HotDrinks**&#x200B;渠道的内容。

同样，如果您使用关键字&#x200B;**cold**（如&#x200B;*）的单词，我想提供冷的*，则渠道开始播放&#x200B;**ColdDrinks**&#x200B;渠道的内容。

**拆分屏幕所需的输出渠道**

**Main**&#x200B;渠道正在播放其内容，但是当您将关键字&#x200B;**hot**&#x200B;和&#x200B;**cold**&#x200B;一起使用时，我想看到热饮和冷饮的菜单&#x200B;*,渠道开始播放&#x200B;**SplitScreen&lt;a&lt;a>的内容9/>渠道。***&#x200B;如果您说&#x200B;*返回主菜单*，它将切换回主渠道。
