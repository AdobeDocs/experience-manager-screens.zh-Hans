...
1. 选择 **序列渠道** 模板来自 **创建** 向导并选择 **下一个**.

   ![demochannel](assets/create-channel2.png)

1. 输入标题为 **ScreensChannel** 并选择 **创建**.
...
| 应用程序渠道 | 允许您在Screens播放器中展示自定义Web应用程序。 |
| 1x1 分屏渠道 | 用于在单个区域中查看组件。 |
| 1x2 分屏渠道 | 允许您在两个区域（水平拆分）中查看资源。 |
| 2X1分屏渠道 | 允许您在两个区域（垂直拆分）中查看资源。 |
| 2x2 分屏渠道 | 允许您在四个区域（在矩阵中水平拆分和垂直拆分）中查看资源。 |
| 2x3 分屏渠道 | 允许您在两个区域（水平拆分）中查看资产，其中一个区域大于另一个区域。 |
...
1. 选择要编辑的通道（如上图所示）。
1. 选择 **编辑** 从操作栏的左上角，以便编辑渠道属性。 编辑器将打开，允许您向要发布的渠道添加资产/组件。
...
1. 选择要编辑的渠道。
1. 选择 **属性** 以查看/编辑渠道属性。 您可以通过下面的选项卡更改选项。
...
选择(**...**)中的 **渠道信息** 操作栏，以便查看属性、编辑内容或更新渠道的缓存（离线内容）。
...
1. **将渠道设置为脱机**
   1. 选择渠道并选择 **属性** 操作栏中的
   1. 导航到 **渠道** 选项卡，并确保取消选中 **开发人员模式（强制渠道联机）** option
   1. 选择 **保存并关闭**
1. **更新离线内容**
   1. 选择渠道并选择 **仪表板** 操作栏中的
   1. 导航到 **渠道信息** 面板并选择 *...*
...
1. 导航到渠道为 **测试项目** > **渠道** > **TestChannel**.
   ...
   选择 **仪表板** ，以便查看播放器的状态。 此 **渠道信息** 面板提供了有关渠道处于在线还是离线状态的信息。

   ![screen_shot_2019-08-01at31458pm](assets/screen_shot_2019-08-01at31458pm.png)

1. 选择 **属性** 操作，然后导航到 **渠道** 选项卡，如下所示：
...
>[!NOTE]
>要将渠道再次配置为脱机，请从取消选中 **属性** 选项卡(如步骤(3)中所示)。 然后，从 **渠道信息** 面板选择 **更新离线内容**，如下图所示。
...
此外，选择以下位置中的显示： **已分配显示区** 面板，查看显示信息，如下所示：
