...
为了支持数字标牌成功部署，通常将项目分成3个阶段。  这些阶段通常称为 **天**. 这些不是字面日期，而是项目每个主要阶段的编号。
...
>
>观看有关以下内容的其他视频： **[项目管理和部署](https://helpx.adobe.com/experience-manager/6-5/screens/using/project-management-and-deployment.html)** 了解有关项目预生产、项目启动和项目进展的信息。
...
>[!NOTE]
>
>本图表并非旨在准确遵循，而是为了提供AEM Screens项目中常见任务和注意事项的示例。

### RACI定义 {#raci-definitions}

* **负责**：完成任务所需完成的工作量。

* **责任人**：委派工作，并且是在任务完成之前最后审核该任务的一方。
