...
# 项目角色和责任{#roles-responsibilities}
...
#### 正在考虑硬件合作伙伴{#selecting-hardware-partner}
...
为了支持成功的数字标牌部署，通常将项目分为3个阶段。  这些阶段通常称为&#x200B;**Days**。 这些不是实际的日期，而是项目每个主要阶段的指定。

1. 第一阶段称为&#x200B;*天零*。 本阶段包括完全定义项目范围所需的所有售前和发现工作。
1. 第二阶段&#x200B;*第1天*&#x200B;是指部署工作中包括的所有活动。
1. 第三阶段和最后阶段&#x200B;*第2天*&#x200B;是指所有正在进行的操作和支持要素，作为整个解决方案的一部分。

>[!NOTE]
>
>虽然本指南着重介绍&#x200B;*第一天*&#x200B;和&#x200B;*第二天*，但必须关注所有三个阶段才能成功地创建数字标记项目。
>
>观看有关&#x200B;**[项目管理和部署](https://helpx.adobe.com/experience-manager/6-5/screens/using/project-management-and-deployment.html)**&#x200B;的其他视频，了解项目前期制作、项目启动和项目进展。
...
>[!NOTE]
>
>本图表并非打算完全遵循，而是提供AEM Screens项目中常见任务和考虑事项的示例。

### RACI定义{#raci-definitions}

* **负责**:完成任务。

* **负责**:委托人工作，是完成任务之前审查该订阅的最后一方。
...
下表总结了&#x200B;**第1天：项目实施（应用程序设计）**:

| **相位** | **A/V集成商** | **AEM实施者** | **业务战略** | **内容管理** |
|---|---|---|---|---|
| 角色和责任协议 | RA | RA | RA | RA |
| 项目计划和计划的对齐 | RA | RA | C | C |
| 评估当前服务器环境 | 我 | RA | 我 | 我 |
| UX设计要求 | 我 | RA | C | RA |
| 技术要求验证 | 我 | RA | RA | C |
| 架构设计 | 我 | RA | 我 | 我 |
...
* **开发人员**:通常是AEM Screens实施小组的成员，或移交给内部开发小组

* **技术人员**:由AV集成商签约或属于同一公司。

下表总结了&#x200B;**第2天：启动后支持RACI图表**:
