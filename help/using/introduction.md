...
此外，Screens还可以根据应用程序部署所在的域，为客户和员工提供许多独特的应用程序，例如：
...
* **停留时间**：通常，设计网页旨在提供大量可在相对较长时间内使用的信息。 相比之下，实地数字体验应当预测查看者的需求，并围绕用户应该怎样参与以及为什么参与，提供简洁而清晰的指导。此类关注可让体验更具针对性、策划性和情境性。
...
AEM Site的格式必须按照其适用显示设备的尺寸来使用。 应先完成此操作，然后再将其放入Screens中的渠道。
